...
namespace AWSAppender.Core.Appenders
{
    /// <summary>
    ...
    public class RenderingForwardingAppender : AppenderSkeleton, IAppenderAttachable
    {
        ...
        /// </para>
        /// </remarks>
        public RenderingForwardingAppender()
        {
        }
        ...
        {
            new LoggingEvent(Type.GetType(loggingEvent.LocationInformation.ClassName), loggingEvent.Repository, loggingEvent.LoggerName, loggingEvent.Level, base.RenderLoggingEvent(loggingEvent), loggingEvent.ExceptionObject);
        ...
        override protected void Append(LoggingEvent[] loggingEvents)
        {
            ...
            var l = new List<LoggingEvent>();
            foreach (var loggingEvent in loggingEvents)
            {
                l.Add(new LoggingEvent(Type.GetType(loggingEvent.LocationInformation.ClassName), loggingEvent.Repository, loggingEvent.LoggerName, loggingEvent.Level, base.RenderLoggingEvent(loggingEvent), loggingEvent.ExceptionObject));
            }
            // Pass the logging event on the the attached appenders
            if (m_appenderAttachedImpl != null)
            {
